      ...
      <main className="app-main">
        ...
        <div className="placeholder-card" style={{ textAlign: 'left', marginBottom: 20 }}>
          ...
          <ol style={{ paddingLeft: 18, margin: '10px 0 0', color: 'var(--ink-soft)' }}>
            <li>
              Abre{' '}
              <a href="https://www.callmebot.com/" target="_blank" rel="noreferrer">
                callmebot.com
              </a>{' '}
              e segue as instruções da secção WhatsApp — o número do bot muda de vez em
              quando (o WhatsApp bane-o periodicamente), por isso confirma sempre lá o
              número atual em vez de usares um número antigo.
            </li>
            <li>
              Adiciona esse contacto no WhatsApp e envia a mensagem:{' '}
              <span className="data">"I allow callmebot to send me messages"</span>
            </li>
            <li>O CallMeBot responde com a tua apikey pessoal — copia-a para aqui em baixo.</li>
          </ol>
          <p style={{ margin: '10px 0 0', fontSize: '0.82rem' }}>
            Se já tinhas uma apikey e o bot "morreu", basta reenviares a mensagem ao número
            novo — a tua apikey mantém-se a mesma, não precisas de a substituir aqui.
          </p>
        </div>
